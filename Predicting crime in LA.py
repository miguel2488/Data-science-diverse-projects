...
"""
'''
THIS PIECE OF WORK INTENDS TO CREATE A MACHINE LEARNING MODEL THAT PREDICTS CRIME IN LA. ALONG THIS PROCESS THE DATA IS CLEANSED
AND TREATED, AND SEVERAL ALGORITHMS ARE OPTIMIZED AND THEIR RESULTS COMPARED. FINALLY, A HEATMAP IS CREATED IN ORDER TO VISUALIZE
THE PREDICTED CRIME POINTS IN THE L.A. AND GET AN IDEA ABOUT WHICH LOCATIONS THE LAW ENFORCEMENT SHOULD FOCUS INTO.
'''
